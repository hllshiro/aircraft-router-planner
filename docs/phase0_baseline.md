...
- **待定数据（发布前，2026-08-05 转换完成，`phase0/data/pending/`，gitignore）**：
  - `gmted2010_7p5as_global.arpack`：**2.311GB**、7.5 弧秒（≈231.9m 赤道）、全球 84°N..56°S 67200×172800、int16、zstd-19、vd=EGM96、空洞率≈0（海洋=0m）；Rust 采样验证：北京 52.1m/青藏 4928.7m/太平洋 0m ✓；>10 弧秒契约满足；体积超 800MB 目标（全球主档口径，待主管裁决）
  - `china_dem_l12.arpack`：**76MB**、9.888 弧秒（≈305.75m 赤道，踩线 ≤10 弧秒）、中国区 73.5-135.1°E / 3.6-53.6°N 18194×22429、有效 29%（NaN=海洋/境外→no_data -32768）、北京 100% 有效；Rust 采样验证：北京 49m/云南 1459.8m/海南 -7.8m ✓
