...
- **P_cross 阈值、衰减模型形态**：`p_cross` 默认 0.1 维持占位（验收阈值，需真实任务剖面标定，非数据可定）；**衰减模型形态已定（2026-08-13）**——Swerling I 典型监视雷达模型（Pfa=1e-6 → VT=13.8155、R_eff 处 base_p=0.9、SNR₀=130.1≈21.1dB、中心→1），"exponential"/"linear" 仍可选
